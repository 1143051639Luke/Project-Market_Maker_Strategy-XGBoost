...
│   ├── any.ipynb                 # Exploratory analysis
│   ├── tools.py                  # Utility functions
│   └── *.json                    # Trained XGBoost models
├── data/
│   ├── data_ob/                  # Order book data (31 days)
│   └── data_trade/               # Trade data (31 days)
└── result/
    ├── step1_5/daily/            # Labeled dataset (parquet)
    └── step3_classifier_full/    # Backtest results (parquet)
```
